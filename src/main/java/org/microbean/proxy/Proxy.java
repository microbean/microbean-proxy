...
public interface Proxy<T> {
  ...
  /**
   * Returns the instance being proxied, not this {@link Proxy}.
   *
  ...
  /**
   * Returns this {@link Proxy}, or a completely substitutable replacement for it, cast to the type of the
   * instance it proxies.
   *
   * <p>The default implementation of this method returns, effectively, {@code (T)this}.</p>
   *
   * @return this {@link Proxy}; never {@code null}
   *
   ...
   *
   * @microbean.idempotency Implementations of this method must be idempotent and deterministic. Specifically, they must
   * always return this {@link Proxy} or a completely substitutable replacement for it, not anything else.
   *
   * @microbean.threadsafety Implementations of this method must be safe for concurrent use by multiple threads.
   */
